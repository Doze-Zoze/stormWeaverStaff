...
namespace stormWeaverStaff.Items
{
	...
	public class ArtificerTempestHead : ModProjectile
	{
        ...
        {
            Texture2D tex = ModContent.Request<Texture2D>("stormWeaverStaff/Items/StormWeaverHead" + (armored ? "_Armor" : "_Naked"), (AssetRequestMode)2).Value;
            Texture2D texBody = ModContent.Request<Texture2D>("stormWeaverStaff/Items/StormWeaverBody" + (armored ? "_Armor" : "_Naked"), (AssetRequestMode)2).Value;
            Texture2D texTail = ModContent.Request<Texture2D>("stormWeaverStaff/Items/StormWeaverTail" + (armored ? "_Armor" : "_Naked"), (AssetRequestMode)2).Value;
